...
porte + zip + log), inclusive em ajuste de Markdown. O operador cobrou em 2026-06-23: "a auditoria
...
## A pergunta-mãe: isso vai pra TERCEIRO/PRODUÇÃO ou fica no vivo do operador?
...
Ajuste no vivo do operador que ele revê na hora e é trivial de desfazer:
...
→ **Faço e sigo.** Sem subagente, sem teste isolado, sem auditoria. No máximo um backup datado se
  for sobrescrever volume. A revisão é o próprio operador lendo o resultado.
...
## O GATILHO da auditoria adversarial (o que o operador cobrou)
...
- Um bug aqui faz o operador abrir algo quebrado / mostrar pro cliente errado.
...
- É algo que o operador revê na hora de qualquer jeito.
...
## Regra de ouro
Calibrar pelo CUSTO DE ERRAR, não pelo "é do CORTEX então é sério". O alvo do operador é VELOCIDADE
