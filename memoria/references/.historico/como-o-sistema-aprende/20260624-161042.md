...
- **Erro vira correção gravada.** Quando o OS erra e o operador corrige, a correção é registrada
  (na skill que errou, no `decisions/log.md`, ou na memória pela regra evitar-retrabalho) pra
  aquele erro não voltar. Falha é dado, não desastre.
